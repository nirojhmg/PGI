import { StyleSheet,Dimensions,FlatList,StatusBar,TouchableOpacity, ScrollView, Text, View,AppRegistry,Image,AsyncStorage,TouchableHighlight,Picker,BackHandler,CheckBox,Animated} from 'react-native';
import {
 ...
 setToastType(message='Success!', type='success') {
    ...
    this.setState({ toastColor: color, message: message })
      ...
      console.log("PickerHolder:"+this.state.PickerValueHolder+"User:"+this.state.user+"Key:"+this.state.key)    
        fetch('http://kyalin.pythonanywhere.com/users/foty/', {
        method: 'POST',
       ...
       "faculty_name": this.state.PickerValueHolder
         ...
         if(responseJson.student !='This field must be unique.'){
...
var elements=[];
    ...
    return(
        <View style={styles.MainContainer}>
         <TouchableOpacity  style={styles.button}   onPress={() =>  this.props.navigation.navigate("StudentMainTabNavigator")} >
