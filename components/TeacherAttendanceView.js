...
export default class TeacherAttendanceView extends Component {
      ...
      constructor(props) {
       ...
       componentDidMount(){
        ...
        AsyncStorage.getItem('fullname').then((user) => {
        ...
        fetch('http://100.121.155.148:8000/users/attendancerecord/')
...
var elements=[];
    ...
    return(
        ...
        <TouchableOpacity  style={styles.button}   onPress={() =>  this.props.navigation.navigate("TeacherAttendance")} >
